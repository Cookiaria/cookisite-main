...
//  ====================
//  wavyyy n rainbow from old website idfk lol

function checkAndInitialize() {
    const wavyElements = document.querySelectorAll('.wavy:not(.ca-initialized)');
    const rainbowElements = document.querySelectorAll('.rainbow:not(.ca-initialized)');
